<template>
  ...
  <div v-else>
    <div class="row">
      <div class="cell-4 offset-1" @click="rpush('/models')">
      ...
      <div class="cell-4 offset-1" @click="rpush('/data')">
        <div class="remark secondary">
          <h3>Data</h3>
    ...
    <div class="row">
      <div class="cell-4 offset-1" @click="rpush('/specifyfit')">
        <div class="remark secondary">
          <h3>Fit Topology</h3>
          Specify a fit by applying models to datasets. Parameters can be shared
          between all datasets, be specific to each datasets, or shared in any
          manner across datasets and/or models.
        </div>
      </div>

      <div class="cell-4 offset-1" @click="rpush('/runfit')">
        <div class="remark secondary">
          <h3>Run Fit</h3>
          Specify good initial guesses for fit parameters and run fit. Make sure
          you mark which parameters are constants and should not be fitted.
        </div>
      </div>
    </div>
